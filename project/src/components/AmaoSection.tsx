    ...
    <section className="py-32 px-6 relative overflow-hidden bg-gradient-to-b from-black via-gray-950 to-black">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="bg-gradient-to-r from-blue-900/30 via-violet-900/30 to-cyan-900/30 border border-blue-800/50 rounded-3xl p-12 overflow-hidden">
          ...
          {/* Enhanced AMAO Live Demo Preview - Inside CTA */}
          <div className="mb-16 border-t border-gray-700/50 pt-12">
            ...
            {/* Interactive 3D Preview Container with Premium Effects */}
            <div className="bg-gradient-to-br from-cyan-950/40 via-blue-950/30 to-violet-950/40 border border-cyan-600/50 rounded-3xl p-12 mb-12 shadow-2xl shadow-cyan-600/30 backdrop-blur-sm">
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                ...
                <div className="flex flex-col">
                  {/* 3D Preview Box with Rotation Animation */}
                  <style>{`
                    @keyframes rotate3d {
                  ...
                  `}</style>
                  <div className="bg-gradient-to-br from-gray-900 to-gray-950 rounded-2xl h-80 border border-gray-700/60 flex items-center justify-center mb-4 overflow-hidden perspective">
                    <div className="preview-rotate text-center">
                      <div className="text-7xl mb-3 drop-shadow-lg">📦</div>
                      <p className="text-gray-300 text-sm font-bold tracking-wide">Original Model</p>
                      <p className="text-gray-500 text-xs mt-1">45,230 Polygons</p>
                    </div>
                  </div>
                ...
                {/* Optimized Model - After */}
                <div className="flex flex-col">
                  {/* 3D Preview Box with Rotation Animation */}
                  <div className="bg-gradient-to-br from-emerald-950/80 to-teal-950/60 rounded-2xl h-80 border border-emerald-500/50 flex items-center justify-center mb-4 overflow-hidden shadow-xl shadow-emerald-500/40 perspective">
                    <div className="preview-rotate text-center">
                      <div className="text-7xl mb-3 drop-shadow-lg">✨</div>
                      <p className="text-emerald-200 text-sm font-bold tracking-wide">Optimized by AMAO</p>
                      <p className="text-emerald-400/80 text-xs mt-1">12,870 Polygons</p>
                    </div>
                  </div>
                  
                  {/* Stats Card with Emerald Accent */}
              ...
              <div className="bg-gradient-to-br from-cyan-600/15 to-emerald-600/10 border border-cyan-500/40 rounded-2xl p-6">
                <h4 className="text-sm uppercase tracking-widest font-bold text-cyan-300 mb-5">AI Analysis Results</h4>
            ...
            <div className="text-center">
              <button className="group px-12 py-4 bg-gradient-to-r from-cyan-600 to-emerald-600 hover:from-cyan-500 hover:to-emerald-500 text-white font-bold text-lg rounded-xl transition-all transform hover:scale-110 shadow-xl hover:shadow-emerald-600/60 active:scale-95">
